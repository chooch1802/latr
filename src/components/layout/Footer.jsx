...
function FooterLink({ href, children }) {
  const cls = "text-white/70 hover:text-white text-base transition-colors duration-200"
  if (href.startsWith('/')) {
  ...
  return (
    <div>
      <div className="hidden md:block">
        <h4 className="text-lg font-bold text-white uppercase tracking-widest mb-6">{title}</h4>
      ...
      <div className="md:hidden border-b border-white/20">
        <button
          ...
          className="w-full flex items-center justify-between py-4 text-white font-bold text-lg cursor-pointer"
          aria-expanded={open}
        >
          {title}
...
export default function Footer() {
  return (
    <footer className="bg-coral-500 text-white" role="contentinfo">
