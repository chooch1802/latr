...
const plans = [
  { weeks: 104, rate: '$50.00/week', badge: 'Lowest', badgeColor: 'bg-navy text-white' },
  { weeks: 78, rate: '$65.90/week', badge: 'Recommended', badgeColor: 'bg-coral-500 text-white', selected: true },
  { weeks: 52, rate: '$98.85/week', badge: 'Fastest', badgeColor: 'bg-emerald-500 text-white' },
]
